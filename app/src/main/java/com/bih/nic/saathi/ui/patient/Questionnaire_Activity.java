...
import com.bih.nic.saathi.Model.DecimalDigitsInputFilter;
...
public class Questionnaire_Activity extends Activity implements AdapterView.OnItemSelectedListener, LocationListener {
...
//        }
    ...
    public void ShowDialog()
    {
        ...
        datedialog = new DatePickerDialog(Questionnaire_Activity.this,
...
//
    ...
    private class Daily_Questionnaire extends AsyncTask<String, Void, String> {
        ...
        private final ProgressDialog progressDialog = new ProgressDialog(Questionnaire_Activity.this);
        ...
        protected String doInBackground(String... param) {
            ...
            String res= WebserviceHelper.UploadAttendanceData(Questionnaire_Activity.this,data);
                        ...
                        ab.setNegativeButton("[ OK ]", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int whichButton) {
                                ...
                                if(role.equals("SUP")){
                                    ...
                                    Intent i=new Intent(Questionnaire_Activity.this,HqHomeActivity.class);
                                    startActivity(i);
                                    finish();
                                }
...
//
    ...
    private final LocationListener mlistener = new LocationListener() {
        ...
        public void onLocationChanged(Location location) {
            ...
            //Update the UI with
            //the location update.
            if (Utiilties.isGPSEnabled(Questionnaire_Activity.this)) {
...
//                        {
                        ...
                        if (Lat1 !=null ||Lat1 !=""){
                            ...
                            if (!GlobalVariables.isOffline && !Utiilties.isOnline(Questionnaire_Activity.this)) {

                                AlertDialog.Builder ab = new AlertDialog.Builder(Questionnaire_Activity.this);
